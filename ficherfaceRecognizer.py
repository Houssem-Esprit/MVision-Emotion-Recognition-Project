...
def make_sets():
    ...
    for emotion in emotions:
        ...
        for item in training:
            ...
            print("emotions infos ","index:",emotions.index(emotion),"emotion :",emotion)
...
print ("Model trained. Saving model to FicherEmotionModel.pickle")
fishface.save('trainedFicherModel.xml')
...
public class Camera2BasicFragment extends Fragment
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (test != null) {
                ...
                RequestBody postBodyImage = new MultipartBody.Builder()
                        ...
                        .build();
                mBackgroundHandler.post(new SendImageData(getActivity(),postUrl,postBodyImage,Emotion));
                test.close();
            }
    ...
    private static class SendImageData implements Runnable {
        ...
        TextView textView;
        public SendImageData(Activity activity,String postUrl, RequestBody postBody,TextView tx) {
            mActivity = activity;
            url = postUrl;
        ...
        public void run() {
            ...
            Log.d("BBBBBBBBBBBBBBBBBBBBBB","BBBBBB");
            Request request = new Request.Builder()
                    .url(url)
                    .post(postBody)
                    .build();
            Log.d("AAAAAAAAAAAAAAAAAAAAA","AAAAAAA");
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    ...
                    // In order to access the TextView inside the UI thread, the code is executed inside runOnUiThrea
                }
                ...
                public void onResponse(Call call, final Response response) throws IOException {
                    ...
                    try {
                         ...
                         Log.d("Response Client","Response Client:    "+Resp);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
